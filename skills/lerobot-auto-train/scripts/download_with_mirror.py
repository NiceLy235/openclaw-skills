...
Strategy:
1. Try huggingface-cli download from huggingface.co
2. If timeout or failure, retry from hf-mirror.com
3. Report which source was used

Usage:
    python download_with_mirror.py --repo-id lerobot/smolvla_base --proxy http://127.0.0.1:10809
"""
